...
export const AnimatedSpan = ({
  ...
  return (
    <motion.div
      ...
      className={cn("animated-span", className)}
      onAnimationComplete={() => {
        if (!sequence) return
...
export const Terminal = ({
  ...
  const content = (
    <div
      ref={containerRef}
      className={cn("terminal__container", className)}
    >
      <div className="terminal__header">
        <div className="terminal__buttons">
          <div className="terminal__button--red"></div>
          <div className="terminal__button--yellow"></div>
          <div className="terminal__button--green"></div>
        </div>
      </div>
      ...
      <pre className="terminal">
        ...
        <div className="terminal__content">
          <div className="terminal__gradient-circle">
            <img src="/emoji.png" alt="emoji" />
          </div>
          <code className="terminal__code">{wrappedChildren}</code>
        </div>
        ...
        <TooltipProvider>
          <Dock className="social-dock">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <a
                  href="https://instagram.com/matheusbmarquesg"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <DockIcon className="dock-icon">
