      ...
      <div className="flex flex-col items-center justify-center space-y-5">
        ...
        <div className="terminal_content w-full">
          <Terminal className="terminal break-words whitespace-normal">
            ...
            <AnimatedSpan className="text break-words whitespace-normal catdriving"><span>➔ conheça o <a href='https://catdriving-chi.vercel.app/' target='_blank'> cat driving</a>.</span></AnimatedSpan>
